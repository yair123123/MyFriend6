...
namespace MyFriend6.Controllers
{
    ...
    {
        private readonly MyFriend6Context _context;

        public PicturesController(MyFriend6Context context)
        {
            _context = context;
        }
        ...
        {
            var myFriend6Context = _context.Picture.Include(p => p.User);
            return View(await myFriend6Context.ToListAsync());
        }
